...
export default component$(() => {
    ...
    const social = [
        ...
        { label: "Facebook", icon: IconFacebook, href: "#" },
        {
            label: "Github",
            icon: IconGithub,
            href: "https://github.com/chadnpc/chadnpc.github.io",
        },
    ];
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div class="md:flex md:items-center md:justify-between py-6 md:py-8">
                    ...
                    <div class="text-sm text-gray-700 mr-4 dark:text-slate-400">
                        <span class="w-5 h-5 md:w-6 md:h-6 md:-mt-0.5 bg-cover mr-1.5 float-left rounded-sm bg-[url(https://chadnpc.com/favicon/favicon-32x32.png)]"></span>
                        Built by{" "}
                        <a class="text-secondary-800 underline dark:text-gray-200" href="https://chadnpc.com">
                            {" "}
                            chadnpc
                        </a>{" "}
